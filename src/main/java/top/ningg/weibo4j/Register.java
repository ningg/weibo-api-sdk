...
public class Register extends Weibo {
    ...
    public JSONObject verifyNickname(String nickname) throws WeiboException {
        return client.get(WeiboConfig.getValue("baseURL") + "register/verify_nickname.json",
                new PostParameter[] { new PostParameter("nickname", nickname) }, access_token).asJSONObject();
    }
}
