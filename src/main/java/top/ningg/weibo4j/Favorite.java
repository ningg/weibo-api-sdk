...
public class Favorite extends Weibo {
    ...
    public JSONObject getFavoritesIds(Paging page) throws WeiboException {
        return client.get(WeiboConfig.getValue("baseURL") + "favorites/ids.json", null, page, access_token).asJSONObject();
    }
    ...
    public Favorites showFavorites(String id) throws WeiboException {
        return new Favorites(client.get(WeiboConfig.getValue("baseURL") + "favorites/show.json", new PostParameter[] { new PostParameter("id", id) },
                access_token));
    }
    ...
    public List<FavoritesIds> getFavoritesIdsByTags(String tid) throws WeiboException {
        return FavoritesIds.constructFavoritesIds(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags/ids.json",
                new PostParameter[] { new PostParameter("tid", tid) }, access_token));
    }
    ...
    public Boolean destroyFavoritesBatch(String ids) throws WeiboException {
        try {
            return client.post(WeiboConfig.getValue("baseURL") + "favorites/destroy_batch.json",
                    new PostParameter[] { new PostParameter("ids", ids) }, access_token).asJSONObject().getBoolean("result");
    ...
    public Favorites updateFavoritesTags(String id, String tags) throws WeiboException {
        return new Favorites(client.post(WeiboConfig.getValue("baseURL") + "favorites/tags/update.json",
                new PostParameter[] { new PostParameter("id", id), new PostParameter("tags", tags) }, access_token));
    }
    ...
    public JSONObject updateFavoritesTagsBatch(String tid, String tag) throws WeiboException {
        return client.post(WeiboConfig.getValue("baseURL") + "favorites/tags/update_batch.json",
                new PostParameter[] { new PostParameter("tid", tid), new PostParameter("tag", tag) }, access_token).asJSONObject();
    }
