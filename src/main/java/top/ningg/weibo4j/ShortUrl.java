...
public class ShortUrl extends Weibo {
    ...
    public JSONObject longToShortUrl(String url_long) throws WeiboException {
        return client.get(WeiboConfig.getValue("baseURL") + "short_url/shorten.json", new PostParameter[] { new PostParameter("url_long", url_long) },
    ...
    public JSONObject shortToLongUrl(String url_short) throws WeiboException {
        return client.get(WeiboConfig.getValue("baseURL") + "short_url/expand.json",
                new PostParameter[] { new PostParameter("url_short", url_short) }, access_token).asJSONObject();
    }
    ...
    public JSONObject statusesContentUrl(Map<String, String> map) throws WeiboException {
        ...
        return client.get(WeiboConfig.getValue("baseURL") + "short_url/share/statuses.json", parList, access_token).asJSONObject();
    }
    ...
    public JSONObject commentsContentUrl(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return client.get(WeiboConfig.getValue("baseURL") + "short_url/comment/comments.json", parList, access_token).asJSONObject();
    }
