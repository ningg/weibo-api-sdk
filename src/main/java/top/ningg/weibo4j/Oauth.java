...
import top.ningg.weibo4j.http.AccessToken;
import top.ningg.weibo4j.http.BASE64Encoder;
...
public class Oauth extends Weibo {
    ...
    public String parseSignedRequest(String signed_request) throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        SecretKey key = new SecretKeySpec(WeiboConfig.getValue("client_SECRET").getBytes(), "hmacSHA256");
        Mac m;
    ...
    public AccessToken getAccessTokenByCode(String code) throws WeiboException {
        return new AccessToken(client.post(WeiboConfig.getValue("accessTokenURL"),
                new PostParameter[] { new PostParameter("client_id", WeiboConfig.getValue("client_ID")),
                        new PostParameter("client_secret", WeiboConfig.getValue("client_SECRET")),
